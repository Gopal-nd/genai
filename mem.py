...
NEO4J_URL="bolt://localhost:7687"   # neo4j url
...
def chat(message):
    ...
    memories = "\n".join([m["memory"] for m in mem_result.get("results")]) # type: ignore
...
## use the dashboard to visualize the data in neo4j and the qdrant